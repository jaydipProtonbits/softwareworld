                                ...
                                <div class="row branding">
                                    <div class="col-lg-8">
                                        <div class="row mb-1">
                                            <div class="col-lg-2">
                                                @if ($listing->logo)
                                                    <img src="{{ asset('assets/company/' . $listing->logo) }}" width="auto"
                                                        height="100px" alt="{{ $listing->name }}">
                                                @else
                                    ...
                                    <div class="col-lg-4 text-end">
                                        <a href="{{ $listing->website }}" class="btn btn-primary" id="visit_website"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="align-items-baseline d-flex justify-content-between menu_inner">
                            <div class="menu_items">
                                <ul class="list-inline mb-1">
                                    <li class="list-inline-item logo-item">
                                        @if ($listing->logo)
                                            <img src="{{ asset('assets/company/' . $listing->logo) }}" height="48px"
                                                width="48px" class="img-fluid" alt="{{ $listing->name }}">
                                        @else
                                            <img src="https://placehold.co/48x48/fdd400/000000/png?text={{ substr($listing->name, 0, 1) }}"
                            ...
                            <div class="menu_btns">
                                <a href="{{ route('front_write_review', ['software', $listing->name]) }}"
                    ...
                    <div class="col-12">
                        <div class="box_inner pb-4">
                            ...
                            <div class="row single_meta mb-md-5">
                                ...
                                <div
                                    class="col-lg-{{ $listing->getMeta('screenshots') ?? false && !empty($listing->getMeta('screenshots')) ? '6' : '12' }}">
                                                        ...
                                                        <div class="swiper-wrapper">
                                                            @foreach ($listing->getMeta('screenshots') ?? [] as $media)
                                                                <div class="swiper-slide"
                                                                    style="background-image:url({{ asset('assets/software/media/' . $media) }})">
                                                                </div>
                                                            @endforeach
                                                        </div>
                                                    </div>
                            ...
                            <div class="soft_details row mt-4 pt-4 border-top">
                                <div class="col-lg-3 mb-4">
                                    ...
                                    <ul class="list-group list-inline gap-3">
                                        <li class="s-fonts">
                                            <img src="{{ asset('assets/img/icons/misc/user-blue-pri.svg') }}">
                                            {{ $listing->name }}
                                        </li>
                                        <li class="s-fonts">
                                            <img src="{{ asset('assets/img/icons/misc/calendar-plain-pri.svg') }}">
                                            {{ $listing->getMeta('year_founded') }}
                                        </li>
                                        <li class="s-fonts">
                                                        ...
                                                        <li>
                                                            <a href="{{ $listing->getMeta('social_profile')[$value] }}">
                                                                @if (strtolower($value) == 'linkedin')
                                                                    <img src="{{ asset('assets/img/icons/' . strtolower($value) . '-web.svg') }}"
                                                                        width="24px" height="24px" class="img-fluid">
                                                                @elseif($value != 'Twitter')
                                                                    <img src="{{ asset('assets/img/icons/' . lcfirst($value) . '-web.svg') }}"
                                                                        width="24px" height="24px" class="img-fluid">
                                                                @else
                                    ...
                                    <ul class="list-group list-inline gap-3">
                                        @if ($listing->getMeta('customer_support') ?? false)
                                            @foreach ($listing->getMeta('customer_support') ?? [] as $support)
                                                <li class="s-fonts">
                                                    <img src="{{ asset('assets/img/icons/misc/checkbox.svg') }}">
                                                    {{ $support }}
                                                </li>
                                            @endforeach
                                        @endif
                                ...
                                <div class="col-lg-3 mb-4">
                                    ...
                                    <ul class="list-group list-inline gap-3">
                                        @if ($listing->getMeta('licensing_model') ?? false)
                                            <li class="s-fonts">
                                                <img src="{{ asset('assets/img/icons/misc/checkbox.svg') }}">
                                                {{ $listing->getMeta('licensing_model') }}
                                            </li>
                                        @endif
                                                ...
                                                <li class="s-fonts">
                                                    @if (!in_array($value, ['Windows', 'Mac', 'Linux']))
                                                        ...
                                                        @if ($listing->getMeta('device_supported_url')[$value] ?? false)
                                                            <a href="{{ $listing->getMeta('device_supported_url')[$value] ?? '' }}"
                                        ...
                                        @foreach (targetCompanySize() as $key => $value)
                                            @if (in_array($value, $listing->getMeta('company_size') ?? []))
                                                <li class="s-fonts"><img
                                                        src="{{ asset('assets/img/icons/misc/checkbox.svg') }}">
                                                    {{ $value }}</li>
                                            @endif
                                        @endforeach
                                    </ul>
                                        ...
                                        @if (!empty($listing->getMeta('features')[$value->id]))
                                            <div class="accordion-item card mb-2">
                                                <h2 class="accordion-header p-0 m-0 accordion-button cursor-pointer"
                                                    ...
                                                    data-bs-target="#accordionStyle1-{{ $key }}"
                                                    aria-expanded="false">
                                                    {{ $value->name }}
                                                    @if (!empty($CatUrl))
                                                        &nbsp;<a class="c-b" href="{{ getPageUrl($CatUrl) }}"
                                                            target="_blank"><i class="ti ti-external-link"></i></a>
                                                    @endif
                                                </h2>
                                                <div id="accordionStyle1-{{ $key }}"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-5 col-xs-12 col-sm-12 border-end">
                                            <div class="row mb-4">
                                                <div class="col-sm-2">
                                                    <img src="{{ asset('assets/img/placeholder/review-man.png') }}"
                                            ...
                                            <div class="row pro_details border-top me-0">
                                                ...
                                                <div class="col-md-4 text-center pt-3">
                                                    ...
                                                    <ul
                                                        ...
                                                        <li><img src="{{ asset('assets/img/icons/linkedin-web.svg') }}"
                                                                width="24px" height="24px" class="img-fluid"></li>
                                                        <li><img src="{{ asset('assets/img/icons/facebook-web.svg') }}"
                                                                width="24px" height="24px" class="img-fluid"></li>
                                                        <li><img src="{{ asset('assets/img/icons/x-web.svg') }}"
                                                                width="24px" height="24px" class="img-fluid"></li>
                                                    </ul>
                                                </div>
                                            </div>
