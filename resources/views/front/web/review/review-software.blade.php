                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="form-label">How much time have you spent with MailChimp?</label>
                                        <div class="d-flex justify-content-start gap-5">
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="Free trial" name="spend[]" id="Spend1">
                                            ...
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="Less than 6 months" name="spend[]" id="Spend2">
                                            ...
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="6-12 months" name="spend[]" id="Spend3">
                                            ...
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="1-2 years" name="spend[]" id="Spend4">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="form-label">How often do you engage with MailChimp?</label>
                                        <div class="d-flex justify-content-start gap-5">
                                            <div class="">
                                                <div class="form-check">
                                ...
                                <div class="col-4 clearfix">
                                    <div class="form-group">
                                        <label class="form-label">Which MailChimp features have you worked with?</label>
                                        <select class="form-control" name="features_worked">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex justify-content-start gap-5">
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" value="Inexpensive" name="price_sales" id="price_sales1">
                                            ...
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" value="Mid Tier" name="price_sales" id="price_sales2">
                                            ...
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" value="Expensive" name="price_sales" id="price_sales3">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="form-label">Have you integrated Freshsales with any other software?</label>
                                        <div class="d-flex justify-content-start gap-5">
                                            <div class="">
                                                <div class="form-check">
                                            ...
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" value="I Don't Know" name="anu_other" id="anu_other3">
