      ...
      @include('admin.listing.sidebar')
        ...
        ,[$type,$listing->id])}}" method="POST" enctype="maltipart/form-data" novalidate>
            ...
            <div class="row g-3">
                <div class="col-12">
                  ...
                  <label class="f-big d-block mb-2 mt-2">
                      <input type="checkbox" class="form-check-label" {{in_array('27x7 Support',$listing->getMeta('customer_support') ?? []) ? 'checked' : ''}} name="customer_support[]" value="27x7 Support"> 24/7 Support
                  </label>

                  <label class="f-big d-block mb-2">
                      <input type="checkbox" class="form-check-label" {{in_array('Email',$listing->getMeta('customer_support') ?? []) ? 'checked' : ''}} name="customer_support[]" value="Email"> Email/Help Desk
                  </label>

                  <label class="f-big d-block mb-2">
                      <input type="checkbox" class="form-check-label" {{in_array('Phone',$listing->getMeta('customer_support') ?? []) ? 'checked' : ''}} name="customer_support[]" value="Phone"> Phone Support
                  </label>
                  ...
                  <label class="f-big d-block mb-2">
                      <input type="checkbox" class="form-check-label" {{in_array('Knowledge Base',$listing->getMeta('customer_support') ?? []) ? 'checked' : ''}} name="customer_support[]" value="Knowledge Base"> Knowledge Base
                  </label>

                  <label class="f-big d-block mb-2">
                      <input type="checkbox" class="form-check-label" {{in_array('FAQs/Forum',$listing->getMeta('customer_support') ?? []) ? 'checked' : ''}} name="customer_support[]" value="FAQs/Forum"> FAQs/Forum
                  </label>
                ...
                <div class="row">
                    <div class="col-md-4">
                      ...
                      <input type="email" name="support_email" id="support_email" class="form-control" placeholder="Enter Support Email" value="{{ $listing->getMeta('support_email') ?? '' }}">
                    </div>
                </div>
                ...
                <div class="col-12">
                  ...
                  <label class="f-big d-block mb-2">
                      <input type="checkbox" class="form-check-label" {{in_array('Live Online',$listing->getMeta('provide_training') ?? []) ? 'checked' : ''}} name="provide_training[]" value="Live Online"> Live Online
                  </label>
                  <label class="f-big d-block mb-2">
                  ...
                  <label class="f-big d-block">
                      <input type="checkbox" class="form-check-label" {{in_array('Videos',$listing->getMeta('provide_training') ?? []) ? 'checked' : ''}} name="provide_training[]" value="Videos"> Videos
                  </label>
                </div>
                <!-- <div class="col-12">
          ...
          {{--<div class="mt-4 ms-auto">
            <button class="btn btn-primary btn-submit">Save & Publish</button>
          </div>--}}
              <div class="row mt-5">
                <div class="col-6 text-start">
                  <a href="{{ (auth()->user()->is_admin()) ? route('details',['integration',$listing->id]) : route('manage_details',['integration',$listing->id]) }}" type="reset" class="btn btn-label-default waves-effect">
