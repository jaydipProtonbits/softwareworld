                  ...
                  <div class="card-body">
                    ...
                    <form method="post" action="{{route('type.update',$type->id)}}">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" value="{{$type->name}}" id="basic-default-fullname" placeholder="Software">
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6 text-end">
                            <button type="button" class="btn btn-danger delete-record" data-id="{{$type->id}}}">Delete Type</button>
                        </div>
                      </div>
