...
@section('page-script')
    ...
    <script>
        ...
        function readMoreFullPage() {
            var moreText = document.getElementById("more_full_page");
            var readMoreButton = document.getElementById("read_more_full_page");
                                            ...
                                            <div class="col-lg-9 border-bottom">
                                                <p class="list_desc">
                                                    ...
                                                    <a href="{{ route('listing_details', [$page->type_id == 1 ? 'service' : 'software', str_replace(' ', '-', $list->name)]) }}"
                                                        id="read-more-about-{{ $list->id }}" target="_blank">Read
                                                        More</a>
                                                </p>
                                                <div>
                                                    {!! substr($list->truncatedLongDescription, 0, 500) ?? null !!}
                                                    @if (strlen($list->truncatedLongDescription) > 500)
                                                        <a href="javascript:void(0);" id="read_more_full_page"
                                                            onclick="readMoreFullPage()">Read
                                                            More <i class="fa-solid fa-chevron-down"></i></a>
                                                        <div id="more_full_page" style="display:none;">
                                                            {!! substr($list->truncatedLongDescription, 0) ?? null !!}
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
