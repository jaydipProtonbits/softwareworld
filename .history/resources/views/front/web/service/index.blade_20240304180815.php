    ...
    <script type="text/javascript">
        jQuery(document).ready(function($) {
            ...
            var client_data = {
                ...
                datasets: [{
                    data: ['{{ $listing->getMeta('client_focus', [])['small'] ?? '0' }}',
                        {{ $listing->getMeta('client_focus', [])['midmarket'] ?? '0' }},
                        {{ $listing->getMeta('client_focus', [])['enterprise'] ?? '0' }}
                    ],
                            ...
                            <div class="card-header pt-3 pb-3">
                                <ul class="list-inline m-0 p-0 m-0">
                                    ...
                                    <li class="list-inline-item"><a href="javascript:void(0)"
                                            class="b_link active">{{ $listing->name }}</a></li>
                                </ul>
                            </div>
                            <div class="card-body mt-3 pb-0 ">
                                <div class="row branding">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2">
                                                <div class="pre_img text-center {{ $listing->logo ? 'bg-white' : '' }}">
                                                    @if ($listing->logo)
                                                        <img src="{{ asset('assets/service/' . $listing->logo) }}"
                                                            width="100px" alt="{{ $listing->name }}">
                                                    @else
                                    ...
                                    <div class="col-lg-4 text-end">
                                        <a href="{{ $listing->website }}" class="btn btn-primary" id="visit_website">VISIT
                        ...
                        <div class="align-items-baseline d-flex justify-content-between menu_inner">
                            <div class="menu_items">
                                <ul class="list-inline mb-1">
                                    <li class="list-inline-item logo-item">
                                        @if ($listing->logo)
                                            <img src="{{ asset('assets/service/' . $listing->logo) }}" height="48px"
                            ...
                            <div class="menu_btns">
                                <a href="javascript:void(0)" class="review_link hide_review_only"><i class="ti ti-edit"></i>
                                    &nbsp; Write a Review</a>
                                <a href="{{ $listing->website }}" class="website_link">VISIT WEBSITE &nbsp; <i
                            ...
                            <div class="row single_locations">
                                <div class="col-lg-3">
                                    <div class="loc_inner">
                                        ...
                                        <p>
                                            {{ $listing->street ?? '' }}, {{ $city_name ?? '' }}, {{ $state_name ?? '' }}
                                            {{ $listing->postal_code ?? '' }}
                                        </p>
                                        <p>
                                ...
                                <div class="col-12 text-end mt-3 d-none">
                                    <a href="javascript:void(0);" id="show_more_loc">Show More1</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    @foreach ($listing->portfolio()->select('thumbnail', 'id')->get() as $portfolio)
                                        <div class="col-lg-4 mb-4">
                                            <a href="javascript:void(0)" onclick="view_portfolio({{ $portfolio->id }})">
                                                <img src="{{ $portfolio->thumbnail_url }}" class="img-fluid"
                                                    data-port_id="{{ $portfolio->id }}">
                                            </a>
                                        </div>
                                    @endforeach
                                @endif
