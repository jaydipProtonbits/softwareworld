                            ...
                            <div class="card-body mt-3 pb-0">
                                ...
                                <div>
                                    ...
                                    <p class="ArticleBody">
                                        ...
                                        @if (strlen(strip_tags($description)) > 50)
                                            ... <a href="javascript:void(0);" id="read_more" class="btn btn-info btn-sm"
                                                onclick="readMore()>Read More</a>
@endif
                                    </p>
                                ...
                                <div class="goto_btn
                                                ...
                                                <a href="javascript:void(0)" class="btn btn-primary ms-0"><img
                                                        src="{{ asset('assets/img/icons/misc/code.svg') }}"> All
                                                    Software</a>
                                                <a href="javascript:void(0)" class="btn btn-primary btn-grey"><img
                                                        src="{{ asset('assets/img/icons/misc/Path.svg') }}"> Buyer’s
                                                    Guide</a>
                                </div>
                            </div>
                        </div>
