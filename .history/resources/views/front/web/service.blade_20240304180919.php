                        ...
                        <div class="card">
                            ...
                            <div class="card-body mt-3 pb-0">
                                ...
                                @if (strlen($description) > 500)
                                    <a href="javascript:void(0);" id="read_more" onclick="readMore()">Show More1 <i
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 border-bottom">
                                                <p class="list_desc">
                                                    ...
                                                    <a
                                                        href="{{ route('listing_details', [$page->type_id == 1 ? 'service' : 'software', str_replace(' ', '-', $list->name)]) }}">Read
                                                        More</a>
                                                </p>
                                            </div>
                                        </div>
