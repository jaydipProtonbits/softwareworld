                            ...
                            <ul class="nav nav-pills me-3 col-lg-4" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="true">Accounting Software1</button>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="tab_accounting_software" role="tabpanel">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ getHomeListing(homePageStaticSoftwareIds(2)[0])['page_url'] }}"
                                                ...
                                                <div class="soft_list_item">
                                                    @if ($soft['logo'])
                                                        <span class="midd_img"><img
                                                                src="{{ asset('assets/company/' . $soft['logo']) }}"
                                                                class="listing-logo mb-2"></span>
                                                    @else
                                                        <img src="https://placehold.co/70x70/fdd400/000000/png?text={{ substr($soft['name'], 0, 1) }}"
                                                            height="100px" width="100px" class="img-fluid mb-2">
                                                    @endif
                                                    <a
                                                        href="{{ route('listing_details', ['software', str_replace(' ', '-', $soft['name'])]) }}">{{ $soft['name'] }}</a>
                                ...
                                <div class="tab-pane fade" id="tab_crm_software" role="tabpanel">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ getHomeListing(homePageStaticSoftwareIds(2)[1])['page_url'] }}"
                                            class="list_tit_link">See All</a>
                                    </div>
                                    <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                                ...
                                <div class="tab-pane fade" id="tab_erp_software" role="tabpanel">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ getHomeListing(homePageStaticSoftwareIds(2)[2])['page_url'] }}"
                                            class="list_tit_link">See All</a>
                                    </div>
                                    <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                                ...
                                <div class="tab-pane fade" id="tab_lms_software" role="tabpanel">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ getHomeListing(homePageStaticSoftwareIds(2)[3])['page_url'] }}"
                                            class="list_tit_link">See All</a>
                                    </div>
                                    <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                                ...
                                <div class="tab-pane fade" id="tab_pm_software" role="tabpanel">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ getHomeListing(homePageStaticSoftwareIds(2)[4])['page_url'] }}"
                                            class="list_tit_link">See All</a>
                                    </div>
                                    <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                                ...
                                <div class="tab-pane fade" id="tab_hr_software" role="tabpanel">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ getHomeListing(homePageStaticSoftwareIds(2)[5])['page_url'] }}"
                                            class="list_tit_link">See All</a>
                                    </div>
                                    <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="tab_s_app_development" role="tabpanel">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ getHomeListing(homePageStaticSoftwareIds(1)[0])['page_url'] }}"
                                            class="list_tit_link">See All</a>
                                    </div>
                                    <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                                        @foreach (array_slice(getHomeListing(homePageStaticSoftwareIds(1)[0])['data'], 0, 8) as $services)
                                            <div class="col">
                                                <div class="soft_list_item">
                                                    @if ($services['logo'])
                                                        <span class="midd_img"><img
                                                                src="{{ asset('assets/service/' . $services['logo']) }}"
                                                                class="listing-logo mb-2"></span>
                                                    @else
                                                        <img src="https://placehold.co/70x70/fdd400/000000/png?text={{ substr($services['name'], 0, 1) }}"
                                                            height="100px" width="100px" class="img-fluid mb-2">
                                                    @endif

                                                    <a
                                                        href="{{ route('listing_details', ['service', str_replace(' ', '-', $services['name'])]) }}">{{ $services['name'] }}</a>
                                                    <div class="soft_list_rating hide_review_only">
                                                        <i class="ti ti-star-filled"></i> 5.0 (4 Reviews)
                                                    </div>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="tab_s_software_development" role="tabpanel">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ getHomeListing(homePageStaticSoftwareIds(1)[1])['page_url'] }}"
                                            class="list_tit_link">See All</a>
                                    </div>
                                    <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                                ...
                                <div class="tab-pane fade" id="tab_s_digital_marketing" role="tabpanel">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ getHomeListing(homePageStaticSoftwareIds(1)[2])['page_url'] }}"
                                            class="list_tit_link">See All</a>
                                    </div>
                                    <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                                ...
                                <div class="tab-pane fade" id="tab_s_web_development" role="tabpanel">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ getHomeListing(homePageStaticSoftwareIds(1)[3])['page_url'] }}"
                                            class="list_tit_link">See All</a>
                                    </div>
                                    <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                                ...
                                <div class="tab-pane fade" id="tab_s_app_design" role="tabpanel">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ getHomeListing(homePageStaticSoftwareIds(1)[4])['page_url'] }}"
                                            class="list_tit_link">See All</a>
                                    </div>
                                    <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                                ...
                                <div class="tab-pane fade" id="tab_s_saas_marketing" role="tabpanel">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ getHomeListing(homePageStaticSoftwareIds(1)[5])['page_url'] }}"
                                            class="list_tit_link">See All</a>
                                    </div>
                                    <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                                    ...
                                    <div class="col">
                                        <div class="row">
                                            <div class="col-lg-5 pe-0">
                                                @if ($soft->logo)
                                                    <img src="{{ asset('assets/company/' . $soft->logo) }}"
                                                        class="listing-logo">
                                                @else
                                                    <img src="https://placehold.co/70x70/fdd400/000000/png?text={{ substr($soft->name, 0, 1) }}"
                                                        height="100px" width="100px" class="img-fluid mb-2">
                                ...
                                @foreach (getLatestService() as $services)
                                    <div class="col">
                                        <div class="row">
                                            <div class="col-lg-5 pe-0">
                                                @if ($services->logo)
                                                    <img src="{{ asset('assets/service/' . $services->logo) }}"
                                                        class="listing-logo">
                                                @else
                                                    <img src="https://placehold.co/70x70/fdd400/000000/png?text={{ substr($services->name, 0, 1) }}"
                                                        height="100px" width="100px" class="img-fluid mb-2">
