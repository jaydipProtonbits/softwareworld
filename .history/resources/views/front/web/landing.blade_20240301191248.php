                            ...
                            <div class="card-body mt-3 pb-0">
                                ...
                                @if(strlen($description) > 500)
                                  ...
                                  <div id="more" style="display:none;">
                                    {!! substr($description, 500) ?? null !!}
                                  </div>
                                @endif
                                </div>

                                <div class="goto_btn mt-3">
                                  <a href="javascript:void(0)" class="btn btn-primary ms-0"><img src="{{asset('assets/img/icons/misc/code.svg')}}"> All Software</a>
                                  <a href="javascript:void(0)" class="btn btn-primary btn-grey"><img src="{{asset('assets/img/icons/misc/Path.svg')}}"> Buyer’s Guide</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                  <div class="col-lg-3 border-bottom border-end">
                                    <div class="branding text-center">
                                      ...
                                      <a style="color: #000" href="{{ route('listing_details', [$page->type_id == 1 ? 'service' : 'software', str_replace(' ', '-', $list->name)]) }}">

                                          @if($list->logo)
                                            <img src="{{ $page->type_id == 1 ? asset('assets/service/'.$list->logo) : asset('assets/company/'.$list->logo) }}" class="listing-logo" alt="{{ $list->name }}">
                                          @else
                                          <div class="pre_img">
                                  ...
                                  <div class="col-lg-9 border-bottom">
                                    <p class="list_desc">
                                      {!! nl2br($list->truncatedLongDescription) ?? '' !!}
                                      <a href="{{ route('listing_details', [$page->type_id == 1 ? 'service' : 'software', str_replace(' ', '-', $list->name)]) }}" id="read-more-about-{{ $list->id }}">Read More</a>
                                    </p>
                                  </div>
                                </div>
                                <div class="row">
                                  ...
                                  <div class="col-lg-9 col-md-12 col-sm-12">
                                    <div class="row item_metas">
                                      ...
                                      <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 text-center">
                                        <a href="{{ $list->website }}" class="btn btn-primary">VISIT WEBSITE <i class="ti ti-external-link"></i></a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
