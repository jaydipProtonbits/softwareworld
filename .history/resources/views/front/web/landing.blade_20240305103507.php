                                            ...
                                            <div class="col-lg-9 border-bottom">
                                                <p class="list_desc">
                                                    ...
                                                    @if (strlen($list->truncatedLongDescription) > 400)
                                                        <a href="{{ route('listing_details', [$page->type_id == 1 ? 'service' : 'software', str_replace(' ', '-', strtolower($list->name))]) }}"
                                                            id="read-more-about-{{ $list->id }}" target="_blank"
                                                            onclick="readMoreAbout()"> ..... 11Read
                                                            More</a>
                                            ...
                                            <div class="col-lg-9 col-md-12 col-sm-12">
                                                <div class="row item_metas">
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 text-center">
                                                        <a href="{{ $list->website }}" class="btn btn-primary"
                                                            target="_blank">VISIT
