                        ...
                        <div class="card">
                            <div class="card-header pt-3 pb-3">
                                <ul class="list-inline m-0 p-0 m-0">
                                    ...
                                    <li class="list-inline-item"><a href="javascript:void(0)" class="b_link active">{{ $page->title ?? null }}</a></li>
                                </ul>
                            </div>
                            <div class="card-body mt-3 pb-0">
                              ...
                              @endif
                                ...
                                <div class="goto_btn mt-3">
                                    <a href="javascript:void(0)" class="btn btn-primary ms-0"><img src="{{asset('assets/img/icons/misc/code.svg')}}"> All Companies</a>
                                ...
                                <div class="row">
                                  <div class="col-lg-4 border-bottom border-end">
                                    <div class="branding text-center">
                                      <a href="{{ route('listing_details', [$page->type_id == 1 ? 'service' : 'software', str_replace(' ', '-', $list->name)]) }}">
                                          @if($list->logo)
                                            <img src="{{ $page->type_id == 1 ? asset('assets/service/'.$list->logo) : asset('assets/company/'.$list->logo) }}" class="listing-logo">
                                          @else
                                          <div class="pre_img">
                                  ...
                                  <div class="col-lg-8 border-bottom">
                                    <p class="list_desc">
                                      ...
                                      <a href="{{ route('listing_details', [$page->type_id == 1 ? 'service' : 'software', str_replace(' ', '-', $list->name)]) }}">Read More</a>
                                    </p>
                                  </div>
                                </div>
