...
public function home()
{
  ...
  public function index()
    ...
    {
      $url = Request::url();
      $url = Str::lower(last(explode('/', $url)));
      Log::info($url);
      ...
      if ($type == 'service')
      {
        ...
        return view('front.web.service.index', compact('listing', 'country_name', 'state_name', 'city_name', 'location_data', 'industries_labels', 'industries_data', 'service_labels', 'service_data', 'key_clients','url'));
      }
      else
      {
        ...
        return view('front.web.software.index', compact('listing', 'countries', 'industries', 'url'));
      }
    }
