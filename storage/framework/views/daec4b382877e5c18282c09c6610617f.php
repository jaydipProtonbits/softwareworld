                            ...
                            <div class="card-body mt-3 pb-0">
                                ...
                                <?php if(strlen($description) > 500): ?>
                                  ...
                                  <div id="more" style="display:none;">
                                    <?php echo substr($description, 500) ?? null; ?>
                                ...
                                <div class="goto_btn mt-3">
                                  <a href="javascript:void(0)" class="btn btn-primary ms-0"><img src="<?php echo e(asset('assets/img/icons/misc/code.svg')); ?>"> All Software</a>
                                ...
                                <div class="row">
                                  <div class="col-lg-3 border-bottom border-end">
                                    <div class="branding text-center">
                                      ...
                                      <a style="color: #000" href="<?php echo e(route('listing_details', [$page->type_id == 1 ? 'service' : 'software', str_replace(' ', '-', $list->name)])); ?>">

                                          <?php if($list->logo): ?>
                                            <img src="<?php echo e($page->type_id == 1 ? asset('assets/service/'.$list->logo) : asset('assets/company/'.$list->logo)); ?>" class="listing-logo" alt="<?php echo e($list->name); ?>">
                                          <?php else: ?>
                                          <div class="pre_img">
                                  ...
                                  <div class="col-lg-9 border-bottom">
                                    <p class="list_desc">
                                      ...
                                      <a href="<?php echo e(route('listing_details', [$page->type_id == 1 ? 'service' : 'software', str_replace(' ', '-', $list->name)])); ?>" id="read-more-about-<?php echo e($list->id); ?>">Read More</a>
                                    </p>
                                  </div>
                                </div>
                                <div class="row">
                                  ...
                                  <div class="col-lg-9 col-md-12 col-sm-12">
                                    <div class="row item_metas">
                                      <div class="col-lg-2 col-md-6 col-sm-6 col-xs-6 border-end text-center">
                                        <img src="<?php echo e(asset('assets/img/icons/misc/calendar-clock.svg')); ?>">
...
<?php echo $__env->make('layouts/web/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/m6ek6c99z96m/public_html/laravel-dev.softwareworld.co/resources/views/front/web/landing.blade.php ENDPATH**/ ?>