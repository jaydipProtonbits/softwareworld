...
<head>
  ...
  <title><?php echo $__env->yieldContent('title'); ?> | <?php echo e(config('variables.templateName') ? config('variables.templateName') : 'TemplateName'); ?></title>
    ...
    <meta property="og:image" content="<?php echo e(asset('assets/img/branding/latest_logo.png')); ?>">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">

    <!-- Twitter meta tags -->
    <meta name="twitter:card" content="<?php echo e(asset('assets/img/branding/latest_logo.png')); ?>">
    ...
    <meta name="twitter:image" content="<?php echo e(asset('assets/img/branding/latest_logo.png')); ?>">
  ...
  <!-- Header Script From Admin -->
  <?php echo getSetting('script_in_header'); ?>
...
<body>
  ...
  <!-- Body Script From Admin -->
  <?php echo getSetting('script_in_body'); ?>

  <!-- Body Script From Admin -->
</body>
<!-- After Body Script From Admin -->
<?php echo getSetting('script_before_body'); ?>

<!-- After Body Script From Admin -->
</html>
<?php /**PATH /home/m6ek6c99z96m/public_html/laravel-dev.softwareworld.co/resources/views/layouts/web/commonFront.blade.php ENDPATH**/ ?>