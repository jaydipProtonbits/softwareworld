...
<?php $__env->startSection('title', 'Browse Service Categories'); ?>
            ...
            <div class="container py-lg-3">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1 class="top_head">Browse Service Categories</h1>
                        <p class="">Find the right Service providers</p>
                    </div>
                    <div class="col-12 mt-lg-4 text-center">
                        <form class="" method="get" onsubmit="return false;" id="searchform_categories">
                            <input type="text" name="q" placeholder="Search Service" class="hunt">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/web/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/m6ek6c99z96m/public_html/laravel-dev.softwareworld.co/resources/views/front/web/browse-service.blade.php ENDPATH**/ ?>