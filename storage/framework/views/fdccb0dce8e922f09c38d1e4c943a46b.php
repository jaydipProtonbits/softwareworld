                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="tab_accounting_software" role="tabpanel">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="<?php echo e(getHomeListing(homePageStaticSoftwareIds(2)[0])['page_url']); ?>" class="list_tit_link">See All</a>
                                </div>
                                    ...
                                    <?php $__currentLoopData = array_slice(getHomeListing(homePageStaticSoftwareIds(2)[0])['data'], 0, 8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $soft): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col">
                                            <div class="soft_list_item">
                                                <?php if($soft['logo']): ?>
                                                    <span class="midd_img"><img src="<?php echo e(asset('assets/company/'.$soft['logo'])); ?>" class="listing-logo mb-2"></span>
                                                <?php else: ?>
                                                    <img src="https://placehold.co/70x70/fdd400/000000/png?text=<?php echo e(substr($soft['name'], 0, 1)); ?>" height="100px" width="100px" class="img-fluid mb-2">
                                                <?php endif; ?>
                                                <a href="<?php echo e(route('listing_details', ['software', str_replace(' ', '-', $soft['name'])])); ?>"><?php echo e($soft['name']); ?></a>
                            ...
                            <div class="tab-pane fade" id="tab_crm_software" role="tabpanel">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="<?php echo e(getHomeListing(homePageStaticSoftwareIds(2)[1])['page_url']); ?>" class="list_tit_link">See All</a>
                                </div>
                                <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                            ...
                            <div class="tab-pane fade" id="tab_erp_software" role="tabpanel">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="<?php echo e(getHomeListing(homePageStaticSoftwareIds(2)[2])['page_url']); ?>" class="list_tit_link">See All</a>
                                </div>
                                <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                            ...
                            <div class="tab-pane fade" id="tab_lms_software" role="tabpanel">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="<?php echo e(getHomeListing(homePageStaticSoftwareIds(2)[3])['page_url']); ?>" class="list_tit_link">See All</a>
                                </div>
                                <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                            ...
                            <div class="tab-pane fade" id="tab_pm_software" role="tabpanel">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="<?php echo e(getHomeListing(homePageStaticSoftwareIds(2)[4])['page_url']); ?>" class="list_tit_link">See All</a>
                                </div>
                                <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                            ...
                            <div class="tab-pane fade" id="tab_hr_software" role="tabpanel">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="<?php echo e(getHomeListing(homePageStaticSoftwareIds(2)[5])['page_url']); ?>" class="list_tit_link">See All</a>
                                </div>
                                <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="tab_s_app_development" role="tabpanel">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="<?php echo e(getHomeListing(homePageStaticSoftwareIds(1)[0])['page_url']); ?>" class="list_tit_link">See All</a>
                                </div>
                                <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                                        ...
                                        <div class="col">
                                            <div class="soft_list_item">
                                                <?php if($services['logo']): ?>
                                                    <span class="midd_img"><img src="<?php echo e(asset('assets/service/'.$services['logo'])); ?>" class="listing-logo mb-2"></span>
                                                <?php else: ?>
                                                    <img src="https://placehold.co/70x70/fdd400/000000/png?text=<?php echo e(substr($services['name'], 0, 1)); ?>" height="100px" width="100px" class="img-fluid mb-2">
                                                <?php endif; ?>

                                                <a href="<?php echo e(route('listing_details', ['service', str_replace(' ', '-', $services['name'])])); ?>"><?php echo e($services['name']); ?></a>
                                                <div class="soft_list_rating hide_review_only">
                                                    <i class="ti ti-star-filled"></i> 5.0 (4 Reviews)
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="tab_s_software_development" role="tabpanel">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="<?php echo e(getHomeListing(homePageStaticSoftwareIds(1)[1])['page_url']); ?>" class="list_tit_link">See All</a>
                                </div>
                                <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                            ...
                            <div class="tab-pane fade" id="tab_s_digital_marketing" role="tabpanel">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="<?php echo e(getHomeListing(homePageStaticSoftwareIds(1)[2])['page_url']); ?>" class="list_tit_link">See All</a>
                                </div>
                                <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                            ...
                            <div class="tab-pane fade" id="tab_s_web_development" role="tabpanel">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="<?php echo e(getHomeListing(homePageStaticSoftwareIds(1)[3])['page_url']); ?>" class="list_tit_link">See All</a>
                                </div>
                                <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                            ...
                            <div class="tab-pane fade" id="tab_s_app_design" role="tabpanel">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="<?php echo e(getHomeListing(homePageStaticSoftwareIds(1)[4])['page_url']); ?>" class="list_tit_link">See All</a>
                                </div>
                                <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                            ...
                            <div class="tab-pane fade" id="tab_s_saas_marketing" role="tabpanel">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="<?php echo e(getHomeListing(homePageStaticSoftwareIds(1)[5])['page_url']); ?>" class="list_tit_link">See All</a>
                                </div>
                                <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-3 g-md-3 gx-lg-3">
                                ...
                                <div class="col">
                                    <div class="row">
                                        <div class="col-lg-5 pe-0">
                                            <?php if($soft->logo): ?>
                                                <img src="<?php echo e(asset('assets/company/'.$soft->logo)); ?>" class="listing-logo">
                                            <?php else: ?>
                                                <img src="https://placehold.co/70x70/fdd400/000000/png?text=<?php echo e(substr($soft->name, 0, 1)); ?>" height="100px" width="100px" class="img-fluid mb-2">
                                            <?php endif; ?>
                                        </div>
                                        <div class="col-lg-7">
                                            <p><a href="<?php echo e(route('listing_details', ['software', str_replace(' ', '-', $soft->name)])); ?>"><?php echo e($soft->name); ?></a></p>
                            ...
                            <?php $__currentLoopData = getLatestService(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $services): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col">
                                    <div class="row">
                                        <div class="col-lg-5 pe-0">
                                            <?php if($services->logo): ?>
                                                <img src="<?php echo e(asset('assets/service/'.$services->logo)); ?>" class="listing-logo">
                                            <?php else: ?>
                                                <img src="https://placehold.co/70x70/fdd400/000000/png?text=<?php echo e(substr($services->name, 0, 1)); ?>" height="100px" width="100px" class="img-fluid mb-2">
                                            <?php endif; ?>
                                        </div>
                                        <div class="col-lg-7">
                                            <p><a href="<?php echo e(route('listing_details', ['service', str_replace(' ', '-', $services->name)])); ?>"><?php echo e($services->name); ?></a></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/web/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/m6ek6c99z96m/public_html/laravel-dev.softwareworld.co/resources/views/front/web/home.blade.php ENDPATH**/ ?>