...
<?php $__env->startSection('page-script'); ?>
  <script type="text/javascript">
    ...
    list_of_claims = $('#list_of_claims').DataTable({
      ...
      order       : [0, 'asc'],
      ajax        : {
        url     : '<?php echo e(route('list_of_claims')); ?>',
        type    : 'post',
        data    : function(d){
    ...
    $(document).on('click', '.approved_claim', function () {
      ...
      Swal.fire({
        ...
        if (result.value) {
          let url = '<?php echo e(route('approve_claim', ':id')); ?>';
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\softwareworld\resources\views/admin/claims/index.blade.php ENDPATH**/ ?>