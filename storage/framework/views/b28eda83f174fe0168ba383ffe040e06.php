  ...
  <div class="footer-top">
    <div class="container">
      <div class="row gx-0 gy-4 g-md-5">
        <div class="col-lg-5">
          <a href="<?php echo e(url('/')); ?>" class="app-brand-link mb-4">
        ...
        <div class="col-lg-3 col-md-4">
          <h6 class="footer-title mb-4">For Business</h6>
            ...
            <ul class="list-unstyled list-inline f-logo">
                <li class="list-inline-item"><a href="javascript:void(0);"><img src="<?php echo e(asset('assets/img/icons/f-linkedin.svg')); ?>"></a></li>
                <li class="list-inline-item"><a href="javascript:void(0);"><img src="<?php echo e(asset('assets/img/icons/f-facebook.svg')); ?>"></a></li>
                <li class="list-inline-item"><a href="javascript:void(0);"><img src="<?php echo e(asset('assets/img/icons/f-twitter.svg')); ?>"></a></li>
            </ul>
        </div>
      </div>
    </div>
    ...
    <div class="container ">
        <div class="row">
              ...
              <div class="col-md-8 text-end p-0">
                <p class="d_copy">Copyright © <script>document.write(new Date().getFullYear());</script> <?php echo e(config('variables.creatorName')); ?>. All Rights Reserved.</p>
              </div>
              <div class="col-md-4 text-end fb_links pe-0">
                <a href="<?php echo e(config('variables.githubFreeUrl')); ?>" class="footer-link me-3" target="_blank">Privacy Policy</a>
                <a href="<?php echo e(config('variables.facebookUrl')); ?>" class="footer-link pe-0" target="_blank">Terms of Use</a>
              </div>
        </div>
    </div>
  </div>
...
<!-- Footer: End -->
<?php /**PATH /home/m6ek6c99z96m/public_html/laravel-dev.softwareworld.co/resources/views/layouts/sections/footer/footer-front.blade.php ENDPATH**/ ?>