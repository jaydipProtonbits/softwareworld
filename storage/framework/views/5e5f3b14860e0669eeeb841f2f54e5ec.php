    ...
    <div id="" class="bs-stepper vertical wizard-vertical-icons-example mt-2">
      ...
      <div class="bs-stepper-content">
        <?php if(count($errors) > 0 ): ?>
          ...
          <?php endif; ?>
        <form id="wizard-validation-form" class="needs-validation1" method="post" action="<?php echo e(route('save_clients',$service->id)); ?>" enctype="multipart/form-data" novalidate>
            <?php echo csrf_field(); ?>
          <!-- Account Details -->
               ...
               <div class="row g-3">
                    ...
                    <div class="account-tab-form-spe onlynumbers clear padding-top">
                        <div class="padding-bottom overflow mb-2 row">
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    <input name="client_focus[small]" id="small" class="form-control client-form-percentage" maxlength="3" type="text" value="<?php echo e($service->getMeta('client_focus',array())['small']??'0'); ?>">
                        ...
                        <div class="padding-bottom overflow mb-2 row">
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    <input name="client_focus[midmarket]" id="midmarket" class="form-control client-form-percentage" maxlength="3" type="text" value="<?php echo e($service->getMeta('client_focus',array())['midmarket']??'0'); ?>">
                                    <span class="input-group-text">%</span>
                                </div>
                            </div>
                        </div>
                        <div class="padding-bottom overflow row">
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    <input name="client_focus[enterprise]" id="enterprise" class="form-control client-form-percentage" maxlength="3" type="text" value="<?php echo e($service->getMeta('client_focus',array())['enterprise']??'0'); ?>">
                                    <span class="input-group-text">%</span>
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="industry-list">
                         ...
                         <ul class="industry-ul" id="indInputUL">
                           <?php $__currentLoopData = $industries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <li class="industry-li"><a ind-id="<?php echo e($value->id); ?>"><?php echo e($value->name); ?></a></li>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         </ul>
                       </div>
                     </div>
                   ...
                   <div class="account-tab-form-spe clear overflow">
                     <div class="form-group overflow">
                       <div class="row no-padding">
                         <?php $__currentLoopData = $industries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <div class="form-group all-industries col-md-4 mt-3 ind-id-<?php echo e($value->id); ?> hide">
                             <input type="hidden" name="data[Industry][<?php echo e($value->id); ?>][industry_id]" value="<?php echo e($value->id); ?>" id="Industry<?php echo e($value->id); ?>CompanyIndustryIndustryId">
                             <label for="Industry<?php echo e($value->id); ?>"><?php echo e($value->name); ?></label>
                             <div class="input-group col-md-8">
                               <input name="data[Industry][<?php echo e($value->id); ?>][percentage]" id="Industry<?php echo e($value->id); ?>" class="form-control industry-percentage" type="text" value="0">
                               <span class="input-group-text">%</span>
                             </div>
                           </div>
                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                 ...
                 <div class="row mt-5">
                   <div class="col-6 text-start">
                     <a href="<?php echo e((auth()->user()->is_admin()) ? route('service_step',['destination',$service->id]) : route('manage_service_step',['destination',$service->id])); ?>" type="reset" class="btn btn-label-default waves-effect">
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/m6ek6c99z96m/public_html/laravel-dev.softwareworld.co/resources/views/admin/service/clients.blade.php ENDPATH**/ ?>