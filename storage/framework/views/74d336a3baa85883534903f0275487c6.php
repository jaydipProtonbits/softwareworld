                            ...
                            <div class="card-header pt-3 pb-3">
                                <ul class="list-inline m-0 p-0 m-0">
                                    ...
                                    <li class="list-inline-item"><a href="javascript:void(0)"
                                            class="b_link active"><?php echo e($page->title ?? null); ?></a></li>
                                </ul>
                            </div>
                            <div class="card-body mt-3 pb-0">
                                ...
                                <?php if(strlen($description) > 500): ?>
                                    ...
                                    <div id="more" style="display:none;">
                                        <span><?php echo substr($description, 0) ?? null; ?></span>
                                    </div>
                                <?php endif; ?>

                                <div class="goto_btn mt-3">
                                    <a href="javascript:void(0)" class="btn btn-primary ms-0"><img
                                            src="<?php echo e(asset('assets/img/icons/misc/code.svg')); ?>"> All Companies</a>
                                                ...
                                                <p class="list_desc">
                                                    ...
                                                    <?php if(strlen($list->truncatedLongDescription) > 400): ?>
                                                        <a href="<?php echo e(route('listing_details', [$page->type_id == 1 ? 'service' : 'software', str_replace(' ', '-', strtolower($list->name))])); ?>"
                                                            ...
                                                            More</a>
                                                        <div id="more" style="display:none;">
                                                            <span><?php echo substr($list->truncatedLongDescription, 0) ?? null; ?></span>
                                                        </div>
                                                    <?php endif; ?>
                                                </p>
                                            </div>
...
<?php echo $__env->make('layouts/web/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\softwareworld\resources\views/front/web/service.blade.php ENDPATH**/ ?>