  ...
  <script type="text/javascript">
    jQuery(document).ready(function($) {
      ...
      var client_data = {
        ...
        datasets: [{
          data: ['<?php echo e($listing->getMeta('client_focus',array())['small'] ?? '0'); ?>', <?php echo e($listing->getMeta('client_focus',array())['midmarket'] ?? '0'); ?>, <?php echo e($listing->getMeta('client_focus',array())['enterprise'] ?? '0'); ?>],
            ...
            <div class="card">
              <div class="card-header pt-3 pb-3">
                <ul class="list-inline m-0 p-0 m-0">
                  ...
                  <li class="list-inline-item"><a href="javascript:void(0)" class="b_link active"><?php echo e($listing->name); ?></a></li>
                </ul>
              </div>
              <div class="card-body mt-3 pb-0 ">
                <div class="row branding">
                    ...
                    <div class="row">
                      <div class="col-lg-2">
                        <div class="pre_img text-center <?php echo e($listing->logo?'bg-white':''); ?>">
                          <?php if($listing->logo): ?>
                            <img src="<?php echo e(asset('assets/service/'.$listing->logo)); ?>" width="100px" alt="<?php echo e($listing->name); ?>">
                          <?php else: ?>
                  ...
                  <div class="col-lg-4 text-end">
                    <a href="<?php echo e($listing->website); ?>" class="btn btn-primary" id="visit_website">VISIT WEBSITE &nbsp;<i class="ti ti-external-link"></i></a>
          ...
          <div class="col-12">
            <div class="align-items-baseline d-flex justify-content-between menu_inner">
              <div class="menu_items">
                <ul class="list-inline mb-1">
                  <li class="list-inline-item logo-item">
                    <?php if($listing->logo): ?>
                      <img src="<?php echo e(asset('assets/service/'.$listing->logo)); ?>" height="48px" width="48px" class="img-fluid" alt="<?php echo e($listing->name); ?>">
                    <?php else: ?>
              ...
              <div class="menu_btns">
                ...
                <a href="<?php echo e($listing->website); ?>" class="website_link">VISIT WEBSITE &nbsp; <i class="ti ti-external-link"></i></a>
              ...
              <div class="row single_locations">
                <div class="col-lg-3">
                  <div class="loc_inner">
                    ...
                    <p>
                      <?php echo e($listing->street ?? ''); ?>, <?php echo e($city_name ?? ''); ?>, <?php echo e($state_name ?? ''); ?> <?php echo e($listing->postal_code ?? ''); ?>
                  ...
                  <?php $__currentLoopData = $listing->portfolio()->select('thumbnail', 'id')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $portfolio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 mb-4">
                      <a href="javascript:void(0)" onclick="view_portfolio(<?php echo e($portfolio->id); ?>)">
                        <img src="<?php echo e($portfolio->thumbnail_url); ?>" class="img-fluid" data-port_id="<?php echo e($portfolio->id); ?>">
                      </a>
                    </div>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-5 col-xs-12 col-sm-12 border-end">
                    <div class="row mb-4">
                      <div class="col-sm-2">
                        <img src="<?php echo e(asset('assets/img/placeholder/review-man.png')); ?>" width="100px" height="100px" class="img-fluid rounded-1">
                      </div>
                      <div class="col-sm-10">
                    ...
                    <div class="row pro_details border-top me-0">
                      ...
                      <div class="col-md-4 text-center pt-3">
                        ...
                        <ul class="list-group list-group-horizontal list-inline gap-3 justify-content-center">
                          <li><img src="<?php echo e(asset('assets/img/icons/linkedin-web.svg')); ?>" width="24px" height="24px" class="img-fluid"></li>
                          <li><img src="<?php echo e(asset('assets/img/icons/facebook-web.svg')); ?>" width="24px" height="24px" class="img-fluid"></li>
                          <li><img src="<?php echo e(asset('assets/img/icons/x-web.svg')); ?>" width="24px" height="24px" class="img-fluid"></li>
                        </ul>
                      </div>
                    </div>
                  </div>
...
<?php echo $__env->make('layouts/web/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/m6ek6c99z96m/public_html/laravel-dev.softwareworld.co/resources/views/front/web/service/index.blade.php ENDPATH**/ ?>