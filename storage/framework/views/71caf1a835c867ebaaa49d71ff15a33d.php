...
<?php $__env->startSection('title', 'Add Integration & API '. $type); ?>
  ...
  <div class="col-12 mb-4">
    <div class="bs-stepper vertical wizard-vertical-icons-example mt-2">
      <?php echo $__env->make('admin.listing.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <form class="needs-validation1" action="<?php echo e(route('saveIntegration'
          ...
          <div id="account-details-vertical" class="content active">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <label class="f-big">
                      <input type="radio" class="form-check-label" name="is_open_api" <?php echo e($listing->getMeta('is_open_api') == 1 ? 'checked' : ''); ?> value="1"> YES
                  </label>&nbsp;&nbsp;
                  <label class="f-big">
                      <input type="radio" class="form-check-label" name="is_open_api" <?php echo e($listing->getMeta('is_open_api') == 0 ? 'checked' : ''); ?> value="0"> No
                  </label>
                </div>
              <div class="col-md-6">
                <div class="form-group <?php echo e($listing->getMeta('is_open_api') == 0 ? 'd-none' : ''); ?>" id="api_url_field">
                  <label class="form-label required-label mt-0">URL For API Document</label>
                  <input type="url" class="form-control" name="api_document_url" placeholder="Enter URL" value="<?php echo e($listing->getMeta('api_document_url')); ?>">
                </div>
                </div>
                <div class="relative form-group softwaresearchextra col-md-6">
                    ...
                    <div id="integrate_software_lists" class="rcatlayout clear form-group common-search-list ">

                        <?php if(!empty($listing->getMeta('integrate_software'))): ?>
                            <?php $integrate_software = getListing($listing->getMeta('integrate_software')); ?>
                            <?php $__currentLoopData = $integrate_software; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $software): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="software-entity" id="<?php echo e($software->id); ?>">
                                    <div class="remove-software">-</div>
                                    <div class="soft_de">
                                        <div class="entity-name"><?php echo e($software->name); ?></div>
                                        <input type="hidden" name="integrate_software[]" value="<?php echo e($software->id); ?>">
                                    </div>
                                </div>
...
<script src="<?php echo e(asset('assets/js/listing.js')); ?>"></script>
  <script type="text/javascript">
        ...
        if (content.hits.length > 0)
        {
            for (var i = 0; i < content.hits.length; ++i)
            {
                ...
                if(hit["logo"] == '')
                    ...
                    company_pic = "<?php echo e(asset('assets/company')); ?>"+'/'+hit["logo"];
    ...
    {
        $.ajax({
            url: "<?php echo e(route('future_software')); ?>", //Don't forget to replace with your own post URL
            type: 'POST',
            data: {'name': enty_name, '_token':'<?php echo e(csrf_token()); ?>'},
          }).done(function(data){
        ...
        $(document).on('keyup', '.software-search-input', function (e) {
            ...
            } else
            {
                ...
                if ($(this).val() != '')
                {
                    ...
                    ajaxRevReq = $.ajax({
                        url: "<?php echo e(route('find_listing')); ?>", //Don't forget to replace with your own post URL
                        type: 'POST',
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/m6ek6c99z96m/public_html/laravel-dev.softwareworld.co/resources/views/admin/listing/integration.blade.php ENDPATH**/ ?>