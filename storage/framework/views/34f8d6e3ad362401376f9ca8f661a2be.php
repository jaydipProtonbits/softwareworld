                ...
                <div class="row branding">
                  <div class="col-lg-8">
                    <div class="row mb-1">
                      <div class="col-lg-2">
                          <?php if($listing->logo): ?>
                            <img src="<?php echo e(asset('assets/company/'.$listing->logo)); ?>" width="auto" height="100px" alt="<?php echo e($listing->name); ?>">
                          <?php else: ?>
                  ...
                  <div class="col-lg-4 text-end">
                    <a href="<?php echo e($listing->website); ?>" class="btn btn-primary" id="visit_website" target="_blank">VISIT WEBSITE &nbsp;<i
        ...
        <div class="row">
          <div class="col-12">
            <div class="align-items-baseline d-flex justify-content-between menu_inner">
              <div class="menu_items">
                <ul class="list-inline mb-1">
                  <li class="list-inline-item logo-item">
                    <?php if($listing->logo): ?>
                      <img src="<?php echo e(asset('assets/company/'.$listing->logo)); ?>" height="48px" width="48px" class="img-fluid" alt="<?php echo e($listing->name); ?>">
                    <?php else: ?>
                      <img src="https://placehold.co/48x48/fdd400/000000/png?text=<?php echo e(substr($listing->name, 0, 1)); ?>" height="48px" width="48px" class="img-fluid">
                    <?php endif; ?>
              ...
              <div class="menu_btns">
                <a href="<?php echo e(route('front_write_review', ['software', $listing->name])); ?>" class="review_link"><i class="ti ti-edit"></i> &nbsp; Write a Review</a>
          ...
          <div class="col-12">
            <div class="box_inner pb-4">
              ...
              <div class="row single_meta mb-md-5">
                ...
                <div class="col-lg-<?php echo e($listing->getMeta('screenshots') ?? false && !empty($listing->getMeta('screenshots')) ? '6' : '12'); ?>">
                          ...
                          <div class="swiper gallery-top">
                            <div class="swiper-wrapper">
                              <?php $__currentLoopData = $listing->getMeta('screenshots') ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="swiper-slide" style="background-image:url(<?php echo e(asset('assets/software/media/'.$media)); ?>)"></div>
              ...
              <div class="soft_details row mt-4 pt-4 border-top">
                <div class="col-lg-3 mb-4">
                  ...
                  <ul class="list-group list-inline gap-3">
                    <li class="s-fonts">
                      <img src="<?php echo e(asset('assets/img/icons/misc/user-blue-pri.svg')); ?>"> <?php echo e($listing->name); ?>

                    </li>
                    <li class="s-fonts">
                      <img src="<?php echo e(asset('assets/img/icons/misc/calendar-plain-pri.svg')); ?>"> <?php echo e($listing->getMeta('year_founded')); ?>
                            ...
                            <li>
                              <a href="<?php echo e($listing->getMeta('social_profile')[$value]); ?>">
                                <?php if(strtolower($value) == 'linkedin'): ?>
                                  <img src="<?php echo e(asset('assets/img/icons/'.strtolower($value).'-web.svg')); ?>" width="24px" height="24px" class="img-fluid">
                                <?php elseif($value != 'Twitter'): ?>
                                  <img src="<?php echo e(asset('assets/img/icons/'.lcfirst($value).'-web.svg')); ?>" width="24px" height="24px" class="img-fluid">
                                <?php else: ?>
                                  <img src="<?php echo e(asset('assets/img/icons/x-web.svg')); ?>" width="24px" height="24px"
                                       class="img-fluid">
                                <?php endif; ?>
                              </a>
                            </li>
                  ...
                  <ul class="list-group list-inline gap-3">
                    <?php if($listing->getMeta('customer_support') ?? false): ?>
                      <?php $__currentLoopData = $listing->getMeta('customer_support') ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $support): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="s-fonts">
                          <img src="<?php echo e(asset('assets/img/icons/misc/checkbox.svg')); ?>"> <?php echo e($support); ?>
                  ...
                  <ul class="list-group list-inline gap-3">
                    <?php if($listing->getMeta('provide_training') ?? false): ?>
                      <?php $__currentLoopData = $listing->getMeta('provide_training') ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $training): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="s-fonts">
                          <img src="<?php echo e(asset('assets/img/icons/misc/checkbox.svg')); ?>"> <?php echo e($training); ?>
                ...
                <div class="col-lg-3 mb-4">
                  ...
                  <ul class="list-group list-inline gap-3">
                    <?php if($listing->getMeta('licensing_model') ?? false): ?>
                      <li class="s-fonts">
                        <img src="<?php echo e(asset('assets/img/icons/misc/checkbox.svg')); ?>"> <?php echo e($listing->getMeta('licensing_model')); ?>
                    ...
                    <?php if($listing->getMeta('software_development_type') ?? false): ?>
                      <?php $__currentLoopData = $listing->getMeta('software_development_type') ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $development_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="s-fonts">
                          <img src="<?php echo e(asset('assets/img/icons/misc/checkbox.svg')); ?>"> <?php echo e($development_type); ?>
                      ...
                      <?php if(in_array($value,$listing->getMeta('device_supported') ?? [])): ?>
                          <li class="s-fonts">
                            <?php if(!in_array($value, ['Windows','Mac','Linux'])): ?>
                              <img src="<?php echo e(asset('assets/img/icons/misc/checkbox.svg')); ?>"> <?php echo e($value); ?>

                              <?php if($listing->getMeta('device_supported_url')[$value] ?? false): ?>
                                <a href="<?php echo e($listing->getMeta('device_supported_url')[$value] ?? ''); ?>" target="_blank"><i class="ti ti-external-link"></i></a>
                              <?php endif; ?>
                            <?php else: ?>
                              <img src="<?php echo e(asset('assets/img/icons/misc/checkbox.svg')); ?>"> <?php echo e($value); ?>
                  ...
                  <ul class="list-group list-inline gap-3">
                    <?php $__currentLoopData = targetCompanySize(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if(in_array($value,$listing->getMeta('company_size')??[])): ?>
                        <li class="s-fonts"><img src="<?php echo e(asset('assets/img/icons/misc/checkbox.svg')); ?>"> <?php echo e($value); ?></li>
                      <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </ul>
                </div>
              ...
              <?php if(!empty($allCat = getCategory($listing->categories))): ?>
                ...
                <?php if(!empty($listing->getMeta('features')[$value->id])): ?>
                    ...
                    <div class="accordion-item card mb-2">
                        <h2 class="accordion-header p-0 m-0 accordion-button cursor-pointer" data-bs-toggle="collapse" data-bs-target="#accordionStyle1-<?php echo e($key); ?>" aria-expanded="false">
                            <?php echo e($value->name); ?>

                            <?php if(!empty($CatUrl)): ?>
                            &nbsp;<a class="c-b" href="<?php echo e(getPageUrl($CatUrl)); ?>" target="_blank"><i class="ti ti-external-link"></i></a>
                            <?php endif; ?>
                        </h2>
                        <div id="accordionStyle1-<?php echo e($key); ?>" class="accordion-collapse collapse <?php echo e($key == 0 ? 'show' : ''); ?>" data-bs-parent="#accordionStyle1">
                                    ...
                                    <?php $__currentLoopData = $feature; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <?php if( !empty($listing->getMeta('features')[$value->id]) && in_array($feat->id, $listing->getMeta('features')[$value->id])): ?>
                                        <li class="s-fonts col-md-4 col-sm-6 col-12 col-lg-3">
                                          <img src="<?php echo e(asset('assets/img/icons/misc/check-round.svg')); ?>"> <?php echo e($feat->name); ?>
            ...
            <div class="box_inner pb-4">
              ...
              <div class="soft_details row mb-5">
                ...
                <div class="col-lg-3">
                  ...
                  <ul class="list-group list-inline gap-3">
                    <li class="s-fonts"><img src="<?php echo e(asset('assets/img/icons/misc/check-round.svg')); ?>">
              ...
              <div class="d-flex gap-2 justify-content-start pt-3 pricing_btn">
                ...
                <a href="<?php echo e($listing->getMeta('pricing_url')); ?>" class="btn btn-secondary" target="_blank">Pricing Page &nbsp;<i
                    class="ti ti-external-link"></i></a>
                <?php endif; ?>
                <?php if(!empty($listing->getMeta('trail_url'))): ?>
                <a href="<?php echo e($listing->getMeta('trail_url')); ?>" class="btn btn-secondary" target="_blank">Trail Page &nbsp;<i
                    class="ti ti-external-link"></i></a>
                <?php endif; ?>
                <?php if(!empty($listing->getMeta('demo_url'))): ?>
                <a href="<?php echo e($listing->getMeta('demo_url')); ?>" class="btn btn-secondary" target="_blank">Demo Page &nbsp;<i
                    class="ti ti-external-link"></i></a>
                <?php endif; ?>
              </div>
                      ...
                      <?php if(!empty($package['name'])): ?>
                        <div class="col">
                          <div class="pack_list border p-3 text-center pb-0">
                            <p class="p-2 pt-0 package_title border-bottom"><?php echo e($package['name']); ?></p>
                            <p class="package_pack">
                              <?php echo e($package['price'] ?? 0); ?>

                              <?php switch($package['units']):
                                case ('one'): ?> One-time <?php break; ?>
                                <?php case ('year'): ?> Per Year <?php break; ?>
                                <?php case ('month'): ?> Per Month <?php break; ?>
                                <?php case ('day'): ?> Per Day <?php break; ?>
                                <?php case ('hour'): ?> Per Hour <?php break; ?>
                                <?php case ('user'): ?> Per User <?php break; ?>
                                <?php case ('feautre'): ?> Per Feature <?php break; ?>
                                <?php default: ?> Per Plan
                              <?php endswitch; ?>
                            </p>
                          </div>
                        </div>
              ...
              <div class="review_sort mb-4">
                <div class="row">
                  <div class="align-items-center review_top_row row">
                    ...
                    <div class="col-lg-2">
                      <a href="<?php echo e(route('front_write_review', ['software', $listing->name])); ?>" class="btn btn-secondary" id="add_review">Write a Review</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-5 col-xs-12 col-sm-12 border-end">
                      <div class="row mb-4">
                        <div class="col-sm-2">
                          <img src="<?php echo e(asset('assets/img/placeholder/review-man.png')); ?>" width="100px" height="100px"
                      ...
                      <div class="row pro_details border-top me-0">
                        ...
                        <div class="col-md-4 text-center pt-3">
                          ...
                          <ul class="list-group list-group-horizontal list-inline gap-3 justify-content-center">
                            <li><img src="<?php echo e(asset('assets/img/icons/linkedin-web.svg')); ?>" width="24px" height="24px"
                                     class="img-fluid"></li>
                            <li><img src="<?php echo e(asset('assets/img/icons/facebook-web.svg')); ?>" width="24px" height="24px"
                                     class="img-fluid"></li>
                            <li><img src="<?php echo e(asset('assets/img/icons/x-web.svg')); ?>" width="24px" height="24px"
                                     class="img-fluid"></li>
                          </ul>
                        </div>
                      </div>
...
<?php echo $__env->make('layouts/web/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/m6ek6c99z96m/public_html/laravel-dev.softwareworld.co/resources/views/front/web/software/index.blade.php ENDPATH**/ ?>